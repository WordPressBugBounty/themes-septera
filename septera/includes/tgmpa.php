...
function cryout_register_addon_plugins() {
	 ...
	 */
	$config = array(
		'id'           => 'septera',                // Unique ID for hashing notices for multiple instances of TGMPA.
		'default_path' => '',                      // Default absolute path to bundled plugins.
		'menu'         => 'septera-addons',		   // Menu slug.
		...
		'strings'      => array(
			'page_title'                      => __( 'Septera Suggested Plugins', 'cryout' ),
			'menu_title'                      => __( 'Septera Addons', 'cryout' ),
