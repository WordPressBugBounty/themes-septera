...
?>
html
					{ font-family: <?php cryout_font_select( $septera_fgeneral, $septera_fgeneralgoogle, true ) ?>;
...
#site-title 		{ font-family: <?php cryout_font_select( $septera_fsitetitle, $septera_fsitetitlegoogle, true ) ?>;
					  font-size: <?php echo esc_html( $septera_fsitetitlesize ) ?>; font-weight: <?php echo esc_html( $septera_fsitetitleweight ) ?>; }

#access ul li a 	{ font-family: <?php cryout_font_select( $septera_fmenu, $septera_fmenugoogle, true ) ?>;
					  font-size: <?php echo esc_html( $septera_fmenusize ) ?>; font-weight: <?php echo esc_html( $septera_fmenuweight ) ?>; }

.widget-title 		{ font-family: <?php cryout_font_select( $septera_fwtitle, $septera_fwtitlegoogle, true ) ?>;
					  font-size: <?php echo esc_html( $septera_fwtitlesize ) ?>; font-weight: <?php echo esc_html( $septera_fwtitleweight ) ?>; }
.widget-container 	{ font-family: <?php cryout_font_select( $septera_fwcontent, $septera_fwcontentgoogle, true ) ?>;
				      font-size: <?php echo esc_html( $septera_fwcontentsize ) ?>; font-weight: <?php echo esc_html( $septera_fwcontentweight ) ?>; }
.entry-title, #reply-title
					{ font-family: <?php cryout_font_select( $septera_ftitles, $septera_ftitlesgoogle, true ) ?>;
					  font-size: <?php echo esc_html( $septera_ftitlessize ) ?>; font-weight: <?php echo esc_html( $septera_ftitlesweight ) ?>; }
.entry-title.singular-title { font-size: <?php echo esc_html( intval( $septera_ftitlessize ) ) ?>%; }
.content-masonry .entry-title { font-size: <?php echo esc_html( intval( $septera_ftitlessize ) * 0.62 ) ?>%; }
<?php
...
h1, h2, h3, h4, h5, h6 { font-family: <?php cryout_font_select( $septera_fheadings, $septera_fheadingsgoogle, true ) ?>;
...
%%scope%% h1, %%scope%% h2, %%scope%% h3, %%scope%% h4, %%scope%% h5, %%scope%% h6 {
	font-family: <?php cryout_font_select( $septera_fheadings, $septera_fheadingsgoogle, true ) ?>;
	font-weight: <?php echo esc_html( $septera_fheadingsweight ) ?>; 
